                    ...
                    <main className='bg-[#ECE7E2]'>
                        <div className="top-green-img-section" style={{ backgroundImage: `url(${backgroundImage})` }}>
                            ...
                            <div className="top-content-centered min-h-[150px] md:min-h-[250px]">
                                <h1 className='md:text-[50px] text-[30px] text-center'>Your Trips</h1>
                                <p className='text-[12px] md:text-[16px] text-center'>View and manage all your trips. You can edit details, update places, or remove any trip at any time.</p>
                        ...
                        <div id='trip-places' className="flex flex-col gap-[50px]">
                            <div className='flex flex-col gap-[20px]'>
                                <div className='grid grid-cols-3 items-top'>
                                    <Link to='/createtrip' className='justify-self-start w-min pt-[10px]'><button className='green-button w-[85px] md:w-[100px] md:w-[160px]'>Create New Trip</button></Link>
