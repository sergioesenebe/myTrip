                        ...
                        <div id='trip-places' className="flex flex-col gap-[50px]">
                            <div className='flex flex-col gap-[20px]'>
                                <div className='grid grid-cols-3 items-center'>
                                    <h1 className="justify-self-start text-3xl font-bold text-[#004643]">Your Trips</h1>
                                    {!menuOpen && <Link to='/createtrip' className='justify-self-center w-min'><button className='green-button w-[160px]'>Create New Trip</button></Link>}
