...
function uploadTrip() {
    ...
    const [tripImageUrl, setTripImageUrl] = useState('https://res.cloudinary.com/drmjf3gno/image/upload/v1753346706/default-country_hxzjcd.jpg');
    ...
    async function handleDeleteTripImage() {
        try {
            ...
            setTripImageUrl('https://res.cloudinary.com/drmjf3gno/image/upload/v1753346706/default-country_hxzjcd.jpg');
            setTripImage('');
